...
if __name__ == '__main__':
    ...
    print('==> make datasets <==')
    file_path = '../../datasets/jd_sample.txt'
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(num_epochs):
            ...
            hr = Metric_HR(5, next_list,sorted_items)
            # ndcg10 = Metric_NDCG(10, next_list,sorted_items)
            ndcg = Metric_NDCG(5,next_list,sorted_items)

            # f = open(file_path,'w')
            print(" epoch {}, mean_loss{:g}, test HR@5: {:g} ndcg@5: {:g}".
                  format(epoch + 1, mean_cost, hr, ndcg))

            print(
                " epoch {}, mean_loss{:g}, test HR@5: {:g} ndcg@5: {:g}".format(
                    epoch + 1, mean_cost, hr, ndcg),
                file=f)
