...
LastEditTime: 2021-11-06 15:08:06
LastEditors: your name
Description: In User Settings Edit
FilePath: \Sequential_Recommendation_Tensorflow-master\models\FPMC\model_FPMC.py
'''
...
class FPMC(object):
    ...
    def build_model(self, in_Seq, in_Usr, in_Neg, in_Pos):
        ...
        self.UI_emb = tf.get_variable("UI_emb",
                                      [self.user_count, self.emb_size],
                                      initializer=self.init)  #[N,e]
