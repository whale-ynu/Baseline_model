...
if __name__ == '__main__':
    ...
    print('==> make datasets <==')
    file_path = '../../datasets/taobao/user_item.txt'
    ...
    f = open('log_tb_5.txt', 'w')
    # f1 = open('next_list.txt', 'w')
    with tf.Session() as sess:
        ...
        for epoch in range(num_epochs):
            ...
            # print(pred_list, next_list, user_list)
            ...
            # print(all_items,pred_list,user_list,items_usr_clicked)
            # print(sorted_items)
            #
            ...
            # print(next_list,file=f1)
            # print('---------------',file=f1)
            # print(sorted_items,file=f1)
            # print('\n', file=f1)
            ...
            print(" epoch {}, mean_loss{:g}, test HR@5: {:g} NDCG@5: {:g}"
                .format(epoch + 1, mean_cost, hr5, ndcg5))

            print(" epoch {}, mean_loss{:g}, test HR@5: {:g} NDCG@5: {:g}"
                .format(epoch + 1, mean_cost, hr5, ndcg5), file=f)
