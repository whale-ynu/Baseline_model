...
class Caser(object):
    ...
    def build_model(self,in_Seq, in_Usr, in_Neg, in_Pos, in_KP):
        with tf.variable_scope('Caser'):
            ...
            self.item_emb = tf.get_variable("item_emb", [self.item_count+4000, self.emb_size]) #[N,e]
            self.user_emb = tf.get_variable("user_emb", [self.user_count+6000, self.emb_size]) #[N,e]
